...
export default function LegendBar() {
  ...
  return (
    <div suppressHydrationWarning className="border-b border-black/10 dark:border-white/10">
      <div suppressHydrationWarning className="max-w-5xl mx-auto px-6 py-3 flex flex-wrap gap-5 items-center">
        <span className="text-[11px] text-neutral-500">{t.legend.label}</span>
        <div suppressHydrationWarning className="flex flex-wrap gap-4">
          <div suppressHydrationWarning className="flex items-center gap-2 text-[11px] text-neutral-500">
