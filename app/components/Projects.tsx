  ...
  return (
    <>
      <section suppressHydrationWarning id="projects" className="border-b border-black/10 dark:border-white/10">
        <div suppressHydrationWarning className="max-w-5xl mx-auto px-6 py-16">
      ...
      <section suppressHydrationWarning className="border-b border-black/10 dark:border-white/10">
        ...
        >
          ...
          <div suppressHydrationWarning className="grid md:grid-cols-3 gap-3">
            {earlyProjects.map(p => (
              <div suppressHydrationWarning key={p.name} className="border border-black/10 dark:border-white/10 rounded-xl p-4 bg-white dark:bg-neutral-900/40">
                <div suppressHydrationWarning className="flex justify-between items-start mb-2">
                ...
                <div suppressHydrationWarning className="flex flex-wrap gap-1">
                  {p.tech.map(tag => (
