...
export default function Contact() {
  ...
  return (
    <section suppressHydrationWarning id="contact" className="border-b border-black/10 dark:border-white/10">
      ...
      >
        <p className="text-[11px] tracking-[0.12em] uppercase text-neutral-500 dark:text-neutral-400 mb-4">
          {t.contact.label}
        </p>

        <div suppressHydrationWarning className="grid gap-8 md:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] md:items-start">
          <div suppressHydrationWarning className="max-w-2xl">
            ...
            <div suppressHydrationWarning className="mt-7 flex flex-wrap gap-3">
              <a
          ...
          <div suppressHydrationWarning className="rounded-[28px] border border-black/10 bg-white/85 p-4 dark:border-white/10 dark:bg-neutral-900/40">
            <div suppressHydrationWarning className="grid gap-3 sm:grid-cols-2">
              <a
                href="mailto:litescudud@gmail.com"
              ...
              >
                <p className="mb-1 text-[11px] uppercase tracking-[0.08em] text-neutral-500 dark:text-neutral-400">Email</p>
              ...
              <a
                ...
                className="rounded-2xl border border-black/8 bg-black/[0.018] p-4 transition-colors hover:bg-black/[0.04] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/15 dark:border-white/8 dark:bg-white/[0.03] dark:hover:bg-white/[0.05] dark:focus-visible:ring-white/20"
              >
                <p className="mb-1 text-[11px] uppercase tracking-[0.08em] text-neutral-500 dark:text-neutral-400">Phone</p>
              ...
              <a
                ...
                className="rounded-2xl border border-black/8 bg-black/[0.018] p-4 transition-colors hover:bg-black/[0.04] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/15 dark:border-white/8 dark:bg-white/[0.03] dark:hover:bg-white/[0.05] dark:focus-visible:ring-white/20"
              >
                <p className="mb-1 text-[11px] uppercase tracking-[0.08em] text-neutral-500 dark:text-neutral-400">{t.contact.linkedin}</p>
              ...
              <a
                ...
                className="rounded-2xl border border-black/8 bg-black/[0.018] p-4 transition-colors hover:bg-black/[0.04] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/15 dark:border-white/8 dark:bg-white/[0.03] dark:hover:bg-white/[0.05] dark:focus-visible:ring-white/20"
              >
                <p className="mb-1 text-[11px] uppercase tracking-[0.08em] text-neutral-500 dark:text-neutral-400">{t.contact.github}</p>
                <p className="text-[14px] font-medium text-neutral-900 dark:text-neutral-100">{t.contact.github} &rarr;</p>
              </a>

              <div suppressHydrationWarning className="rounded-2xl border border-black/8 bg-black/[0.018] p-4 sm:col-span-2 dark:border-white/8 dark:bg-white/[0.03]">
                <p className="mb-1 text-[11px] uppercase tracking-[0.08em] text-neutral-500 dark:text-neutral-400">{t.contact.location}</p>
